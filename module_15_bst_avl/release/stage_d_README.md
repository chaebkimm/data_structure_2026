# Module 15 - Stage D: Beginner Textbook and Models
...
- `diagrams/bst_avl_models.md` supplies exact linear equivalents for strict
  order, edge-height, balance factor, all four rotation cases, validation,
  and the 15-key experiment.
