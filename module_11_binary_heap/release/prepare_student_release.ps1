...
$stages = @(
    ...
    @{
        Name = "module_11_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_11_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_11_stage_d_textbook_models.zip"
        Entries = @(
            @{ Source = "release\stage_d_README.md"; Entry = "README.md" },
            @{ Source = "student\textbook.md"; Entry = "textbook.md" },
            @{ Source = "diagrams\binary_heap_models.md"; Entry = "diagrams/binary_heap_models.md" }
        )
    },
    @{
        Name = "module_11_stage_e_lab.zip"
        Entries = @(
            ...
            @{ Source = "student\binary_heap_autopsy.md"; Entry = "student/binary_heap_autopsy.md" },
