...
Use this linear-format worksheet after the Cognitive Pause and instructor
comparison. Preserve Sections A through F before opening Stage D. Sections
G through I are later work.
...
1. head is R, size is 3, and limit is 4;
2. R stores value 17 and next Q;
3. Q stores value 23 and next P; and
4. P stores value 31 and next NULL.
...
From R storing 17, continuing at P storing 31, then NULL, trace the saved
successor and released node on each iteration. State the exact all-zero
final `head`, `size`, and `limit`.
...
Analyze these ordered actions:

1. release `victim`;
2. read `victim->next` into `successor`;
3. set `previous->next` to `successor`.
...
Response after A-B: _________________________________________________

Response after C-D: _________________________________________________

Response after A-C: _________________________________________________

Response after E-F: _________________________________________________

Response after G-H: _________________________________________________

Response after E-G: _________________________________________________

Response after A-E: _________________________________________________
...
1. parent is A, A, A, C, A, E, E, G;
2. component size is 8, 0, 0, 0, 0, 0, 0, 0; and
3. component count is 1.
...
1. the linked push-front mutation core;
2. search or removal by value;
3. destruction or full list validation;
4. creating all singleton DSU sets; and
5. optimized find or union over a long sequence.
...
The main fixture has:

1. A-B with weight 1 and ID 0;
2. A-B with weight 4 and ID 1;
3. A-C with weight 3 and ID 2;
4. B-C with weight 2 and ID 3; and
5. C-D with weight 5 and ID 4.
