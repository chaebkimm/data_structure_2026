...
$stages = @(
    @{
        Name = "module_05_stage_a_initial_inquiry.zip"
        Entries = @(
    ...
    @{
        Name = "module_05_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_05_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_05_stage_d_textbook_models.zip"
        Entries = @(
    ...
    @{
        Name = "module_05_stage_e_lab.zip"
        Entries = @(
            ...
            @{ Source = "student\tree_dfs_autopsy.md"; Entry = "student/tree_dfs_autopsy.md" },
            ...
            @{ Source = "code\include\tree_dfs.h"; Entry = "code/include/tree_dfs.h" },
            @{ Source = "code\include\tree_node_stack.h"; Entry = "code/include/tree_node_stack.h" },
            @{ Source = "code\starter\tree_dfs.c"; Entry = "code/starter/tree_dfs.c" },
            @{ Source = "code\support\tree_support.c"; Entry = "code/support/tree_support.c" },
            @{ Source = "code\support\tree_node_stack.c"; Entry = "code/support/tree_node_stack.c" },
            ...
            @{ Source = "code\autopsy\faulty_preorder.c"; Entry = "code/autopsy/faulty_preorder.c" }
        )
    }
)
