...
$stages = @(
    @{
        Name = "module_12_stage_a_initial_inquiry.zip"
        Entries = @(
    ...
    @{
        Name = "module_12_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_12_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_12_stage_d_textbook_models.zip"
        Entries = @(
            @{ Source = "release\stage_d_README.md"; Entry = "README.md" },
            @{ Source = "student\textbook.md"; Entry = "textbook.md" },
            @{ Source = "diagrams\dijkstra_models.md"; Entry = "diagrams/dijkstra_models.md" }
        )
    },
    @{
        Name = "module_12_stage_e_lab.zip"
        Entries = @(
            ...
            @{ Source = "student\dijkstra_autopsy.md"; Entry = "student/dijkstra_autopsy.md" },
            ...
            @{ Source = "code\include\weighted_graph.h"; Entry = "code/include/weighted_graph.h" },
            @{ Source = "code\include\dijkstra_frontier.h"; Entry = "code/include/dijkstra_frontier.h" },
            @{ Source = "code\include\dijkstra.h"; Entry = "code/include/dijkstra.h" },
            @{ Source = "code\starter\dijkstra.c"; Entry = "code/starter/dijkstra.c" },
            @{ Source = "code\support\weighted_graph.c"; Entry = "code/support/weighted_graph.c" },
            @{ Source = "code\support\dijkstra_frontier.c"; Entry = "code/support/dijkstra_frontier.c" },
            ...
            @{ Source = "code\autopsy\faulty_overflow.c"; Entry = "code/autopsy/faulty_overflow.c" }
        )
    }
)
