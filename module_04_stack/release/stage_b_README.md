# Module 4 — Stage B: Fixed Stack Representation and Pause
...
values, and expression-precedence explanation. Open `vocabulary.md` only
after preserving that response. An approved extended-time or separately
scheduled response uses the same targets; speed and drawing quality are not
assessed.
