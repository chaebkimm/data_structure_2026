...
$stages = @(
    @{
        Name = "module_04_stage_a_initial_inquiry.zip"
        Entries = @(
    ...
    @{
        Name = "module_04_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_04_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_04_stage_d_textbook_models.zip"
        Entries = @(
