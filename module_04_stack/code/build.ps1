...
if ($Target -eq "autopsy") {
    ...
    $implementationDirectory = Join-Path $codeRoot $Target
    $implementationSources = @(
        (Join-Path $implementationDirectory "char_stack.c"),
        (Join-Path $implementationDirectory "delimiter_validator.c")
    )
