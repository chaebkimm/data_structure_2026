...
$stages = @(
    @{
        Name = "module_06_stage_a_initial_inquiry.zip"
        Entries = @(
    ...
    @{
        Name = "module_06_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_06_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_06_stage_d_textbook_models.zip"
        Entries = @(
            @{ Source = "release\stage_d_README.md"; Entry = "README.md" },
            @{ Source = "student\textbook.md"; Entry = "textbook.md" },
            @{ Source = "diagrams\dfs_models.md"; Entry = "diagrams/dfs_models.md" }
        )
    },
    @{
        Name = "module_06_stage_e_lab.zip"
        Entries = @(
            ...
            @{ Source = "student\graph_dfs_autopsy.md"; Entry = "student/graph_dfs_autopsy.md" },
            ...
            @{ Source = "code\include\graph_dfs.h"; Entry = "code/include/graph_dfs.h" },
            @{ Source = "code\include\vertex_stack.h"; Entry = "code/include/vertex_stack.h" },
            @{ Source = "code\support\graph_matrix.c"; Entry = "code/support/graph_matrix.c" },
            @{ Source = "code\support\vertex_stack.c"; Entry = "code/support/vertex_stack.c" },
            @{ Source = "code\starter\graph_dfs.c"; Entry = "code/starter/graph_dfs.c" },
            @{ Source = "code\tests\test_core.c"; Entry = "code/tests/test_core.c" },
            @{ Source = "code\tests\test_student.c"; Entry = "code/tests/test_student.c" },
            @{ Source = "code\tests\test_self_loop.c"; Entry = "code/tests/test_self_loop.c" },
            @{ Source = "code\autopsy\README.md"; Entry = "code/autopsy/README.md" },
            @{ Source = "code\autopsy\faulty_cycle_dfs.c"; Entry = "code/autopsy/faulty_cycle_dfs.c" }
        )
    }
)
