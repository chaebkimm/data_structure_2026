...
$stages = @(
    @{
        Name = "module_07_stage_a_initial_inquiry.zip"
        Entries = @(
    ...
    @{
        Name = "module_07_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_07_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_07_stage_d_textbook_models.zip"
        Entries = @(
            @{ Source = "release\stage_d_README.md"; Entry = "README.md" },
            @{ Source = "student\textbook.md"; Entry = "textbook.md" },
            @{ Source = "diagrams\queue_models.md"; Entry = "diagrams/queue_models.md" }
        )
    },
    @{
        Name = "module_07_stage_e_lab.zip"
        Entries = @(
            ...
            @{ Source = "student\queue_autopsy.md"; Entry = "student/queue_autopsy.md" },
            ...
            @{ Source = "code\include\event_queue.h"; Entry = "code/include/event_queue.h" },
            @{ Source = "code\starter\event_queue.c"; Entry = "code/starter/event_queue.c" },
            ...
            @{ Source = "code\autopsy\faulty_wrap.c"; Entry = "code/autopsy/faulty_wrap.c" }
        )
    }
)
