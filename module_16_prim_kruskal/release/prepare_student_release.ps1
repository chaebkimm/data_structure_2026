...
$stages = @(
    @{
        Name = "module_16_stage_a_initial_inquiry.zip"
        Entries = @(
    ...
    @{
        Name = "module_16_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_16_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_16_stage_d_textbook_models.zip"
        Entries = @(
    ...
    @{
        Name = "module_16_stage_e_lab.zip"
        Entries = @(
