...
$stages = @(
    @{
        Name = "module_08_stage_a_initial_inquiry.zip"
        Entries = @(
    ...
    @{
        Name = "module_08_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_08_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_08_stage_d_textbook_models.zip"
        Entries = @(
            @{ Source = "release\stage_d_README.md"; Entry = "README.md" },
            @{ Source = "student\textbook.md"; Entry = "textbook.md" },
            @{ Source = "diagrams\bfs_models.md"; Entry = "diagrams/bfs_models.md" }
        )
    },
    @{
        Name = "module_08_stage_e_lab.zip"
        Entries = @(
            ...
            @{ Source = "student\tree_bfs_autopsy.md"; Entry = "student/tree_bfs_autopsy.md" },
            ...
            @{ Source = "code\include\tree_bfs.h"; Entry = "code/include/tree_bfs.h" },
            @{ Source = "code\include\tree_work_queue.h"; Entry = "code/include/tree_work_queue.h" },
            @{ Source = "code\starter\tree_bfs.c"; Entry = "code/starter/tree_bfs.c" },
            @{ Source = "code\support\tree_support.c"; Entry = "code/support/tree_support.c" },
            @{ Source = "code\support\tree_work_queue.c"; Entry = "code/support/tree_work_queue.c" },
            ...
            @{ Source = "code\autopsy\faulty_shallowest.c"; Entry = "code/autopsy/faulty_shallowest.c" }
        )
    }
)
