...
|---|---:|---|
| Representation and invariants | 20 | Accurate memory model, ownership, valid ranges, and success/failure invariants |
...
| Complexity and structure selection | 10 | Correct operation costs, amortized-growth explanation, and justified representation comparison |
...
The required core works on specified cases, ownership is clear, tests are appropriate, and the student accurately explains the memory state.
