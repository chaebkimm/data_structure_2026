...
$stages = @(
    @{
        Name = "module_09_stage_a_initial_inquiry.zip"
        Entries = @(
    ...
    @{
        Name = "module_09_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_09_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_09_stage_d_textbook_models.zip"
        Entries = @(
            @{ Source = "release\stage_d_README.md"; Entry = "README.md" },
            @{ Source = "student\textbook.md"; Entry = "textbook.md" },
            @{ Source = "diagrams\graph_bfs_models.md"; Entry = "diagrams/graph_bfs_models.md" }
        )
    },
    @{
        Name = "module_09_stage_e_lab.zip"
        Entries = @(
            ...
            @{ Source = "student\graph_bfs_autopsy.md"; Entry = "student/graph_bfs_autopsy.md" },
            ...
            @{ Source = "code\include\graph_matrix.h"; Entry = "code/include/graph_matrix.h" },
            @{ Source = "code\include\graph_adj_list.h"; Entry = "code/include/graph_adj_list.h" },
            @{ Source = "code\include\graph_bfs.h"; Entry = "code/include/graph_bfs.h" },
            @{ Source = "code\include\vertex_queue.h"; Entry = "code/include/vertex_queue.h" },
            @{ Source = "code\starter\graph_bfs.c"; Entry = "code/starter/graph_bfs.c" },
            @{ Source = "code\support\graph_matrix.c"; Entry = "code/support/graph_matrix.c" },
            @{ Source = "code\support\graph_adj_list.c"; Entry = "code/support/graph_adj_list.c" },
            @{ Source = "code\support\graph_bfs_support.c"; Entry = "code/support/graph_bfs_support.c" },
            @{ Source = "code\support\vertex_queue.c"; Entry = "code/support/vertex_queue.c" },
            ...
            @{ Source = "code\autopsy\faulty_frontier.c"; Entry = "code/autopsy/faulty_frontier.c" }
        )
    }
)
