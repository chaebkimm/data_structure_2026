...
if ($Target -eq "autopsy") {
    ...
    $sources = @(
        (Join-Path $codeRoot "autopsy\faulty_frontier.c")
    )
    $outputName = "graph_bfs_autopsy"
} else {
    $sources = @(
        (Join-Path $codeRoot "support\graph_matrix.c"),
        (Join-Path $codeRoot "support\graph_adj_list.c"),
        (Join-Path $codeRoot "support\graph_bfs_support.c"),
        (Join-Path $codeRoot "support\vertex_queue.c"),
        (Join-Path $codeRoot "starter\graph_bfs.c")
    )
