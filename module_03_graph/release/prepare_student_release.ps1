...
$stages = @(
    @{
        Name = "module_03_stage_a_initial_inquiry.zip"
        Entries = @(
    ...
    @{
        Name = "module_03_stage_b_representation_pause.zip"
        Entries = @(
    ...
    @{
        Name = "module_03_stage_c_investigation.zip"
        Entries = @(
    ...
    @{
        Name = "module_03_stage_d_textbook_models.zip"
        Entries = @(
    ...
    @{
        Name = "module_03_stage_e_lab.zip"
        Entries = @(
            ...
            @{ Source = "student\matrix_autopsy.md"; Entry = "student/matrix_autopsy.md" },
            ...
            @{ Source = "code\starter\graph_matrix.c"; Entry = "code/starter/graph_matrix.c" },
