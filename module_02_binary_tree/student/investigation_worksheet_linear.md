...
This version has the same targets without tables or drawing requirements.
Use a screen reader, keyboard, speech input, or plain text. Preserve
predictions before checking.
...
- Index 0 stores `'2'`; both children are -1.
- Index 1 stores `'*'`; its left child is 0 and right child is 2.
- Index 2 stores `'3'`; both children are -1.
- Index 3 stores `'+'`; its left child is 1 and right child is 5.
- Index 4 stores `'4'`; both children are -1.
- Index 5 stores `'*'`; its left child is 4 and right child is 6.
- Index 6 stores `'5'`; both children are -1.
