...
$stages = @(
    @{
        Name = "module_02_stage_a_initial_inquiry.zip"
        Entries = @(
            @{
    ...
    @{
        Name = "module_02_stage_b_representation_pause.zip"
        Entries = @(
            @{
    ...
    @{
        Name = "module_02_stage_c_investigation.zip"
        Entries = @(
            @{
    ...
    @{
        Name = "module_02_stage_d_textbook_models.zip"
        Entries = @(
            @{
    ...
    @{
        Name = "module_02_stage_e_lab.zip"
        Entries = @(
            @{
            ...
            @{
                Source = "student\tree_autopsy.md"
                Entry = "student/tree_autopsy.md"
            },
            @{
